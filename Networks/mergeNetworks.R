...
# === Manually fix errors ===  
  ...
  # Not present in many photosynthetic organisms
  merged_network <- merged_network |>
    remove_ko(
      ko = "K02635, K02637, K02634, K02636, K02643, K03689, K02640",
      ko_remove = "K02643"
    )
  
  merged_network <- merged_network |>
    remove_ko(
      ko = "K02635, K02637, K02634, K02636, K03689, K02640",
      ko_remove = "K03689"
    )
  
  merged_network <- merged_network |>
    remove_ko(
      ko = "K02635, K02637, K02634, K02636, K02640",
      ko_remove = "K02640"
    )
