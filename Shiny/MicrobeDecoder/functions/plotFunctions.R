...
# --- Plot heatmap ---
  ...
  plot_heatmap <- function(df, title = NULL, coord_fixed = TRUE, x_to_y_ratio = 1, horizontal_border = 1, vertical_border = 1, showlegend = FALSE, max_label_length = 15, min_color = "black", max_color = "green", 
    ...
    palette_background = generate_color_palette(n_colors = 2, 
                                                min_color = colorspace::lighten(col = min_color, amount = 0.1), 
                                                max_color = colorspace::darken(col = max_color, amount = 0.1))
