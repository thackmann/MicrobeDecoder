  ...
  homeUI <- function(id) {
    ...
    htmltools::tagList(
        ...
        bslib::layout_column_wrap(
          ...
          div(
            home_button(button_name = ns('jump_history'), position = "right", icon_background_color = "#bb65a8", image_name = "history", title = "History", subtitle = "View past searches and predictions"),
            align = "left"
          ),
          div(
            home_button(button_name = ns('jump_databaseSearch'), position = "left", icon_background_color = "#26b784", image_name = "databaseSearch", title = "Search database", subtitle = "Find data for thousands of organisms"),
            align = "right"
          ),
          div(
            home_button(button_name = ns('jump_databaseDownload'), position = "right", icon_background_color = "#808285", image_name = "databaseDownload", title = "Download database", subtitle = "For use in Excel or other programs"),
            align = "left"
          ),
          div(
